...
class Settings:
    ...
    LOWER_PRICE: Optional[float] = float(os.getenv("LOWER_PRICE")) if os.getenv("LOWER_PRICE") else None
    UPPER_PRICE: Optional[float] = float(os.getenv("UPPER_PRICE")) if os.getenv("UPPER_PRICE") else None
